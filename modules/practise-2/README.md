...
| `JsonReportSaver` | Реализация сохранения отчёта в JSON-файл. |
| `XmlReportSaver` | Реализация сохранения отчёта в XML-файл. |
| `CompositeReportSaver` | Передаёт отчёт нескольким сохранителям, чтобы создать файлы всех выбранных форматов. |
...
- файлы TXT, JSON и XML в каталоге для отчётов с датой и временем в имени;
